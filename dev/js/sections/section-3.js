...
section3TL.from("#section-3 #right-cloud3", {duration: 0.5, alpha:0, x:300});
section3TL.from("#section-3 #left-cloud", {duration: 0.5, alpha:0, x:-300});
...
section3TL.from("#section-3 #right-cloud", {duration: 0.5, alpha:0, x:300});
